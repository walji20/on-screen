...
/**
 * As a extension for when a tag is found it will ignore calls within
 * blockedTime.
 * 
...
public class HandleTagDiscoverWithBlock implements HandleTagDiscover {
	 ...
	 * 
	 * @param cHTIDD
	 *            what to continue handling with if not blocked.
	 */
	...
	/**
	 * @param text
	 *            that was discovered that will be sent forward if not blocked.
	 */
